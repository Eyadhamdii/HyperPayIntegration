...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("HyperPayIntegration") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "HyperPayIntegration", DisplayName = "HyperPayIntegration API", Resources = { "HyperPayIntegration" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["HyperPayIntegration_Web:ClientId"];
        ...
        {
            var swaggerRootUrl = configurationSection["HyperPayIntegration_Swagger:RootUrl"]?.TrimEnd('/');
