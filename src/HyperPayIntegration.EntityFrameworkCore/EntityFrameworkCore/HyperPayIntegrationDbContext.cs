...
public class HyperPayIntegrationDbContext :
    AbpDbContext<HyperPayIntegrationDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public HyperPayIntegrationDbContext(DbContextOptions<HyperPayIntegrationDbContext> options)
        : base(options)
    {
